...
<aside id="hs-sidebar" class="hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-slate-200 lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 shadow-sm" role="dialog" tabindex="-1" aria-label="Sidebar">
  <div class="flex flex-col h-full">
    ...
    <nav class="flex-1 overflow-y-auto p-3 space-y-4 text-sm">
      ...
      $groups = [
        'ภาพรวม' => [$navLink('index', 'แดชบอร์ด', 'dashboard')],
        'เนื้อหาเว็บไซต์' => [
